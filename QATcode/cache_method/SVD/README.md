...
python QATcode/cache_method/SVD/correlate_svd_similarity.py \
  ...
  --similarity_npz QATcode/cache_method/L1_L2_cosine/T_100/v2_latest/result_npz/model_input_blocks_0.npz \
...
python QATcode/cache_method/SVD/correlate_svd_similarity.py \
  ...
  --similarity_npz_dir QATcode/cache_method/L1_L2_cosine/T_100/v2_latest/result_npz \
  --output_root QATcode/cache_method/SVD/correlation \
  --plot \
  --all
```
