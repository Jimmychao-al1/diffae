...
PYTHON=python3
SCRIPT="QATcode/cache_method/L1_L2_cosine/similarity_calculation.py"
...
LOG_DIR="QATcode/cache_method/L1_L2_cosine/logs"
mkdir -p "$LOG_DIR"
...
for BLOCK in "${BLOCKS[@]}"; do
  ...
  echo "=============================="
  echo "Running similarity for block: $BLOCK"
  echo "Log: $LOG_FILE"
  echo "=============================="
